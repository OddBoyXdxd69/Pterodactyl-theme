...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        // Run the Universal Backup Schedule checks
        $schedule->command(\Pterodactyl\Console\Commands\Maintenance\UniversalBackupCommand::class)->everyMinute()->withoutOverlapping();
