        ...
        @if(is_null($server->transfer))
            <div class="col-sm-4">
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        <p>
                            Transfer this server to another node connected to this panel. All server files, allocations, and configurations will be automatically migrated.
                        </p>
                    </div>
                    ...
                    <div class="box-footer">
                        ...
                        @else
                            ...
                            <p style="padding-top: 1rem;">Transferring a server requires at least one node to be configured on your panel.</p>
                        @endif
                    </div>
                </div>
            </div>
                                        ...
                                        <optgroup label="{{ $location->long }} ({{ $location->short }})">
                                            @foreach($location->nodes as $node)
                                                <option value="{{ $node->id }}"
                                                        @if($node->id === old('node_id') || $node->id === $server->node_id) selected @endif
                                                >{{ $node->name }} @if($node->id == $server->node_id) (Current Node / Re-allocate) @endif</option>
                                            @endforeach
                                        </optgroup>
                                    @endforeach
                                </select>
