...
Route::get('/tickets/config', [Admin\Settings\TicketsConfigController::class, 'index'])->name('admin.tickets.config');
Route::patch('/tickets/config', [Admin\Settings\TicketsConfigController::class, 'update']);
